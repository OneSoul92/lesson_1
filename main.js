...
document.body.addEventListener('click', function(event) {
  // Проверяем, был ли щелчок на модальном окне или его элементе вызова
  if (event.target === modalWindow) {
    // Если щелчок произошел на модальном окне или его элементе вызова,
    // не закрываем окно
    return;
  }

  // Если щелчок произошел вне модального окна и его элемента вызова, закрываем окно
  closeModal();
});